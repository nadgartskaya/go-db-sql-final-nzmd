...
func (s ParcelStore) GetByClient(client int) ([]Parcel, error) {
	...
	parcelsByClient, err := s.db.Query(
		"SELECT number, status, address, created_at FROM parcel WHERE client = :client",
	...
	for parcelsByClient.Next() {
		...
		err := parcelsByClient.Scan(&p.Number, &p.Status, &p.Address, &p.CreatedAt)
